...
## Решение
PDF-файл с описанием проделанной работы и выводами [ [X](product_case2026.pdf) ]

Ноутбук с полным кодом решения [ [X](tbank_product_case_autumn2026.ipynb) ]
...
**Все данные находятся в одном [Excel-файле](product_case.xlsx) с двумя листами:**
